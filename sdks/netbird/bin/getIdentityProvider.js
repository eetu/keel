...
function getIdentityProvider(args, opts) {
    ...
    return pulumi.runtime.invoke("netbird:index/getIdentityProvider:getIdentityProvider", {
        "id": args.id,
        "name": args.name,
...
function getIdentityProviderOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("netbird:index/getIdentityProvider:getIdentityProvider", {
        "id": args.id,
        "name": args.name,
    }, opts, utilities.getPackage());
}
