...
exports.ReverseProxyDomain = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("./utilities"));
class ReverseProxyDomain extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ReverseProxyDomain(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'netbird:index/reverseProxyDomain:ReverseProxyDomain';
    /**
...
exports.ReverseProxyDomain = ReverseProxyDomain;
//# sourceMappingURL=reverseProxyDomain.js.map